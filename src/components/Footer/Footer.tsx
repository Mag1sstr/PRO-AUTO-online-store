    ...
    <footer className={styles.footer}>
      <div className="container">
        <div className={styles.row}>
          <img src={logoImg} alt="logo" width={168} />
          <ul className={styles.links}>
            <li className={styles.link}>КОМПАНИЯ</li>
            <li className={styles.link}>О КОМПАНИИ</li>
            <li className={styles.link}>ЛИЦЕНЗИИ</li>
            <li className={styles.link}>ПАРТНЕРЫ</li>
            <li className={styles.link}>ОТЗЫВЫ КЛИЕНТОВ</li>
            <li className={styles.link}>РЕКВИЗИТЫ</li>
            <li className={styles.link}>ВАКАНСИИ</li>
          </ul>
          <ul className={styles.links}>
            <li className={styles.link}>КАТАЛОГ</li>
            <li className={styles.link}>Компрессоры</li>
          </ul>
          <ul className={styles.links}>
          ...
          <ul className={styles.links}>
            ...
            <li className={styles.link}>СТАТЬИ</li>
            <li className={styles.link}>ВОПРОС - ОТВЕТ</li>
          </ul>
          <div className={styles.contacts}>
            ...
            <Button width={176} height={40} fontSize={12} end>
              ЗАКАЗАТЬ ЗВОНОК
            </Button>
          </div>
        </div>
